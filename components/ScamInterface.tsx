...
const ScamInterface: React.FC<Props> = ({ scam, player, onUpdateScam, onScamEnd, onAbort, onOpenInventory, onConsumeItem, onAction }) => {
  ...
  // ... (Return statement same as before but check variables)
  return (
